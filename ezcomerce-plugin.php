 ...
 */
require(EZ_PLUGIN_DIR . '/extend_price_by_role/extend-price-by-role.php');
 ...
 */
require(EZ_PLUGIN_DIR . '/fees_by_role/admin/fees-by-role-menu.php');
add_action('admin_menu', 'add_fees_by_role_content');